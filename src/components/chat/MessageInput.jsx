...
export default function MessageInput({ onSendMessage, disabled = false }) {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-800/90 to-slate-800/80 backdrop-blur-xl border-t border-slate-700/50 p-3 shadow-2xl">
      <form onSubmit={handleSubmit} className="flex items-end space-x-3">
        <div className="flex-1 relative">
          <div className="relative">
            <textarea
              ...
              className="w-full resize-none rounded-xl bg-slate-700/80 backdrop-blur-sm border border-slate-600/50 text-slate-50 placeholder-slate-400 px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 focus:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] max-h-[100px] shadow-lg transition-all duration-300 hover:border-slate-500/50"
              rows="1"
            />
        ...
        <button
          ...
          className="group flex-shrink-0 bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 disabled:from-slate-600 disabled:to-slate-600 disabled:cursor-not-allowed text-white p-3 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-800 transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 disabled:hover:scale-100 disabled:hover:shadow-none"
